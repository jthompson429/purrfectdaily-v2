...
export default function MedicationFormDialog({ open, onOpenChange, item, onSave, pets = [] }) {
  ...
  const submit = async (e) => {
    ...
    if (pets.length > 0 && !form.pet_id) { setError("Please select the pet receiving this medication."); return; }
        ...
        <form onSubmit={submit} className="space-y-4 mt-2">
          ...
          {pets.length > 0 && (
            <div className="space-y-1.5">
              ...
              <Select value={form.pet_id} onValueChange={(value) => set("pet_id", value)}>
